export default {
  step1: {
    ...
    rules: 'rules',
    rule1: '1. After applying for an invoice, the electronic invoice will be issued within 1-3 working days. If the qualification review is passed, the VAT special invoice (paper) will be mailed to you within 10 working days after the electronic invoice is issued;',
  ...
  step4: {
    ...
    finishTips: 'The electronic invoice is expected to be sent to your email within 1-3 working days. Please be patient for the delivery of the paper invoice.',
    reapply: 'reapply',
