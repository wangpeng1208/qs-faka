 ...
 * @var  $order object 订单
 * @var $config array 配置
 * @field  params 应用ID:appid|商户号:mch_id|商户v3私钥:mch_secret_key|商户私钥证书:mch_secret_cert|商户公钥证书:mch_public_cert_path|支付公钥证.书序列号:cert_serial_no|支付公钥证书:wechat_public_cert_path
 */
