...
(22,'sina_app_key',''),
(23,'sina_app_secret',''),
(24,'suo_app_key','6209ae6d41fb7cd01413eb4d45@ebe9e520aa886c17517c5aad213d730e'),
(25,'site_shortlink_domain',''),
...
(76,'cash_emailnotify_open','0'),
(77,'suolink_app_key',''),
(78,'suolink_app_domain',''),
...
(15,'merchantGoodsTrash','trash','商品回收站','merchant/goods/good/trash',NULL,10,'merchant',0,1,NULL,'M',NULL,0,1),
...
(28,'merchantChartsRanklist','ranklist','累计消费','merchant/charts/ranklist',NULL,27,'merchant',0,0,NULL,'M',NULL,0,1),
...
(38,'AdminOrderList','list','订单列表','/admin/order/list/index','article',37,'admin',0,0,'','M','adminapi/order/order/list',0,1),
(39,'adminWorkbench','workbench','工作台','admin/workbench/index','desktop',0,'admin',1,0,'','M','workbench',0,1),
(40,'adminPermissionAdmin','admin','管理员','admin/permission/admin/index','user-safety',34,'admin',0,0,'','M','adminapi/permission/adminapi/list',0,1),
(41,'adminSetting','setting','系统设置','layout','setting',0,'admin',2,0,'/admin/setting/website','L','',0,1),
(43,'adminSettingWebsite','website','站点配置','admin/setting/website/index','dart-board',41,'admin',0,0,'','M','adminapi/config/config/getConfig',0,1),
(44,'adminSettingRegister','register','注册设置','admin/setting/register/index','assignment-user',41,'admin',0,0,'','M','adminapi/config/config/getConfig',0,1),
(46,'adminChannel','channel','通道管理','layout','money',0,'admin',8,0,'/admin/channel/pay_type','L','',0,1),
(47,'adminChannelCollection','collection','收款通道','admin/channel/collection/index','arrow-left-right-1',46,'admin',20,0,'','M','adminapi/channel/collection/list',0,1),
(48,'adminChannelPay_type','pay_type','支付方式分类','admin/channel/pay_type/index','letters-p',46,'admin',0,0,'','M','adminapi/channel/payType/list',0,1),
(49,'adminMerchant','merchant','商户管理','layout','user-1',0,'admin',49,0,'/admin/merchant/user','L','',0,1),
(50,'adminMerchantUser','user','用户管理','admin/merchant/user/index','user-add',49,'admin',50,0,'','M','adminapi/merchant/user/list',0,1),
(54,'adminShop','shop','商城管理','Layout','layers',0,'admin',54,0,'/admin/shop/goods','L','',0,1),
(62,'adminShopGoods','goods','商品管理','admin/goods/goods/index','shop',54,'admin',62,0,'','M','adminapi/goods/goods/list',0,1),
(63,'adminOrderConfig','config','订单配置','admin/order/config/index','textbox',37,'admin',63,0,'','M','adminapi/order/order/list',0,1),
(66,'adminMerchantMoney_log','money_log','资金日志','admin/merchant/money-log/index','fact-check',49,'admin',66,0,'','M','adminapi/merchant/moneylog/list',0,1),
(67,'adminChannelSettlement','settlement','结算通道','admin/channel/settlement/index','functions',46,'admin',67,0,'','M','adminapi/channel/collection/list',0,1),
(69,'adminChannelCollectionAccount','collection/account','账号管理','admin/channel/collection/account/index','user-locked',46,'admin',69,1,'','M','adminapi/channel/collection/list',0,1),
(70,'adminChannelSettlement/account','settlement/account','结算账号','admin/channel/settlement/account/index','usergroup',46,'admin',70,1,'','M','adminapi/channel/collection/list',0,1),
(71,'adminChannelConfig','config','结算配置','admin/channel/settlement/config/index','chart-radial',46,'admin',71,0,'','M','adminapi/config/config/getConfig',0,1),
(72,'adminOrderMerchant','merchant','商户分析','admin/order/analysis/merchant/index','user-setting',37,'admin',72,0,'','M','adminapi/order/analysis/merchant',0,1),
(73,'adminOrderChannel','channel','渠道分析','admin/order/analysis/channel/index','blockchain',37,'admin',73,0,'','M','adminapi/order/analysis/channel',0,1),
(76,'adminMerchantLoginlog','loginlog','登录日志','admin/merchant/loginlog/index','chart-add',49,'admin',76,0,'','M','adminapi/merchant/user/loginlog',0,1),
(88,'adminMerchantRole','role','商户角色','admin/merchant/role/index','user-transmit',49,'admin',88,0,'','M','adminapi/merchant/role/list',0,1),
(89,'adminMerchantCash','cash','提现管理','admin/merchant/cash/index','money',49,'admin',89,0,'','M','adminapi/merchant/cash/list',0,1),
(98,'adminPermissionLog','log','操作日志','admin/permission/log/index','system-log',34,'admin',98,0,'','M','adminapi/permission/log/list',0,1),
(135,'adminOrderComplaint','complaint','投诉管理','admin/order/complaint/index','call-cancel',37,'admin',135,0,'','M','adminapi/order/complaint/list',0,1),
(136,'adminOrderComplaint/detail','complaint/detail','投诉详情','admin/order/complaint/detail','call-incoming',37,'admin',136,1,'','M','adminapi/order/complaint/detail',0,1),
...
(142,'adminArticleIndex','index','文章管理','admin/article/article/index','calendar-1',141,'admin',142,0,'','M','adminapi/article/article/list',0,1),
(145,'adminArticleCategory','category','文章分类','admin/article/category/index','frame-1',141,'admin',145,0,'','M','adminapi/article/articleCategory/list',0,1),
(150,'adminMerchantShop','shop','店铺管理','admin/merchant/shop/index','user-list',49,'admin',150,0,'','M','adminapi/merchant/shop/list',0,1),
...
(168,'adminSettingNotification','notification','消息通知','BLANK','chat-bubble-history',41,'admin',168,0,'','L','',0,1),
...
(177,'adminSettingNotificationList','list','通知设置','admin/setting/notification/index','chat-bubble-add',168,'admin',177,0,'','M','adminapi/system/notification/index',0,1),
(178,'adminSettingNotificationSms','sms','短信配置','admin/setting/notification/sms','chat-bubble',168,'admin',178,0,'','M','adminapi/system/notification/smsType',0,1),
(179,'adminSettingNotificationEmail','email','邮箱配置','admin/setting/notification/email','tips-double',168,'admin',179,0,'','M','adminapi/config/config/editConfig',0,1),
(180,'adminSettingSystem','system','系统维护','BLANK','tools',41,'admin',180,0,'','L','',0,1),
(181,'adminSettingSystemEnvironment','environment','系统环境','admin/setting/system/environment','chart-radar',180,'admin',181,0,'','M','adminapi/setting/system/environment',0,1),
(182,'adminSettingSystemCache','cache','系统缓存','admin/setting/system/cache','delete-time',180,'admin',182,0,'','M','adminapi/system/system/cache',0,1),
