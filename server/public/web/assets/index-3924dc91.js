import{bF as A,a_ as m,q as i,T as b,ai as y,C as O,aj as d,m as w,t as C,w as S}from"./index-ebc513dd.js";import{r as T,d as P,t as M,I as $,A as E,b as j,M as h,F as _,i as I}from"./vue-51c2f431.js";/**
 * tdesign v1.16.1
 * (c) 2025 tdesign
 * @license MIT
 ...
 * (c) 2025 tdesign
 * @license MIT
 */function q(t){return typeof t=="function"||Object.prototype.toString.call(t)==="[object Object]"&&!_(t)}var K=P({name:"TCol",inject:["rowContext"],props:W,setup:function(e){var n=w("col"),o=C(),c=I("rowContext",Object.create(null)),s=R(),r=j(function(){return L(n.value,e)}),a=j(function(){var u={},p=e.flex;if(p&&(u.flex=F(p)),c){var f=c.gutter;Object.assign(u,J(f,s.value))}return u});return function(){var u,p=e.tag;return h(p,{class:r.value,style:a.value},q(u=o("default"))?u:{default:function(){return[u]}})}}});/**
 * tdesign v1.16.1
 * (c) 2025 tdesign
 * @license MIT
 */var H=S(V),Q=S(K);export{Q as C,H as R};
